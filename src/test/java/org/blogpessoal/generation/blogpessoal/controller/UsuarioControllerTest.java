...
import org.blogpessoal.generation.blogpessoal.repository.UsuarioRepository;
import org.blogpessoal.generation.blogpessoal.service.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario
				(new Usuario(0L, "Juliana Andrews","juliana_andrews@email.com.br",
		...
		ResponseEntity<Usuario> corpoResposta = testRestTemplate.withBasicAuth
				("root@root.com", "rootroot").exchange("/usuarios/atualizar", HttpMethod.PUT,
						corpoRequisicao, Usuario.class);
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Ricardo Marques",
				"ricardo_marques@email.com.br", "ricardo123","https://i.imgur.com/Sk5SjWE.jpg"));
